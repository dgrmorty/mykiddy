...
export const ONBOARDING_STEPS: OnboardingStepDef[] = [
  ...
  },
  {
    ...
    title: 'Ученики',
    body: 'Список одноклассников, заявки в друзья и друзья — на вкладке «Список». Лента проектов — на «Витрина» (на главной тоже показывается лента).',
  },
  {
    anchor: 'notifications-home',
    title: 'Уведомления',
    body: 'Колокольчик в боковом меню (на телефоне — в верхней шапке): заявки в друзья, модерация витрины для наставников и ответы по проектам.',
  },
  {
    anchor: 'nav-profile',
    title: 'Профиль',
  ...
  },
  {
    anchor: 'nav-home',
    title: 'Главная',
    body: 'Плашка «кто ты» и лента проектов. Удобная точка входа после входа в сервис.',
  },
  {
    anchor: 'nav-admin',
    title: 'Управление',
