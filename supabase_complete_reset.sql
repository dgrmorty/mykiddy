-- ============================================
-- ПОЛНОЕ ПЕРЕСОЗДАНИЕ БАЗЫ ДАННЫХ С НУЛЯ
-- Удаляет ВСЕ и создает заново БЕЗ рекурсии
...
-- ШАГ 4: СОЗДАЕМ ПРОСТЫЕ ПОЛИТИКИ БЕЗ РЕКУРСИИ
-- ============================================

-- PROFILES: ТОЛЬКО пользователи могут видеть и обновлять СВОИ профили
-- НИКАКИХ проверок админов через profiles - это вызывает рекурсию!
...
-- ШАГ 5: СОЗДАЕМ ФУНКЦИИ И ТРИГГЕРЫ
-- ============================================
...
-- 
-- ВАЖНО: 
-- - Админы управляют контентом через приложение (проверка email на клиенте)
