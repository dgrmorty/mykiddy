...
ПРАВИЛА ОЦЕНКИ:
- Если ответ правильный и соответствует заданию → начни с "ACCEPTED"
- Если ученик старался, но есть небольшие ошибки → начни с "ACCEPTED" и укажи на ошибки мягко
- Если ответ частично правильный, но видно старание → начни с "ACCEPTED" и предложи улучшения
- Только если ответ совсем не по теме, пустой или явно случайный → начни с "NEEDS_WORK"
...
Язык: РУССКИЙ.`;
        ...
        const response = await ai.models.generateContent({
            ...
            config: {
                ...
                Если ответ правильный или ученик старался (даже с ошибками), начинаешь с "ACCEPTED".
                Только если ответ совсем не по теме или пустой, начинаешь с "NEEDS_WORK".
